...
sed -i "s/192\.168\.[0-9]*\.[0-9]*/192.168.126.1/g" $(find ./feeds/luci/modules/luci-mod-system/ -type f -name "flash.js")
sed -i 's/192.168.1.1/192.168.126.1/g' package/base-files/luci2/bin/config_generate
